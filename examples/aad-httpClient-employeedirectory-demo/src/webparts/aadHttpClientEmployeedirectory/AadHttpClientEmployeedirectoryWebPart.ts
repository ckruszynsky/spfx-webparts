...
import styles from './AadHttpClientEmployeedirectoryWebPart.module.scss';
import * as strings from 'AadHttpClientEmployeedirectoryWebPartStrings';

export interface IAadHttpClientEmployeedirectoryWebPartProps {
  description: string;
}

export default class AadHttpClientEmployeedirectoryWebPart extends BaseClientSideWebPart<IAadHttpClientEmployeedirectoryWebPartProps> {
   ...
   protected onInit(): Promise<void> {
    this.employeeService = new EmployeeService(this.context.aadHttpClientFactory);
   ...
   public render(): void {
    if (!this.renderedOnce) {
      this.domElement.innerHTML = `
        <div class="${styles.aadHttpClientEmployeedirectory}">
